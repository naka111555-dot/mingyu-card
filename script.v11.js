...
const cars = {
  "DOLPHIN": { image: "assets/dolphin.png?v=11", title: "DOLPHIN", desc: "감각적인 디자인과 실용성을 겸비한 소형 해치백" },
  "ATTO 3": { image: "assets/atto3.png?v=11", title: "ATTO 3", desc: "실용성과 공간 활용성이 돋보이는 전기 SUV" },
  "SEAL": { image: "assets/seal.png?v=11", title: "SEAL", desc: "세련된 퍼포먼스와 디자인을 갖춘 전기 세단" },
  "SEALION 7": { image: "assets/sealion7.png?v=11", title: "SEALION 7", desc: "넓은 공간감과 미래지향적 스타일의 전기 SUV" },
  "SEALION 6": { image: "assets/sealion6.webp?v=11", title: "SEALION 6", desc: "균형 잡힌 주행감과 실용성을 갖춘 SUV" }
};
...
function copyAddress() {
  ...
  navigator.clipboard.writeText(address)
    .then(function() { alert("주소가 복사되었습니다."); })
    .catch(function() { alert(address); });
}
...
function calculateSaving() {
  ...
  const evEfficiency = { "DOLPHIN": 6.2, "ATTO 3": 5.4, "SEAL": 5.8, "SEALION 7": 5.1, "SEALION 6": 5.0 };
